...
event = require("event")
local admins = { "Angel172ir16", "Cyanide3D", "cobraonee"}
...
if not require("filesystem").exists("/lib/durexdb.lua") then
    if not require("component").isAvailable("internet") then
        ...
        shell.execute("wget -q https://raw.githubusercontent.com/Angel172ir16/OpenComputers-Casino/blob/master/durexDB.lua /lib/durexdb.lua")
    end
end
